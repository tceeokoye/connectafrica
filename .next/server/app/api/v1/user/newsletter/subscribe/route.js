"use strict";(()=>{var e={};e.id=228,e.ids=[228],e.modules={38013:e=>{e.exports=require("mongodb")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},61282:e=>{e.exports=require("child_process")},84770:e=>{e.exports=require("crypto")},80665:e=>{e.exports=require("dns")},17702:e=>{e.exports=require("events")},92048:e=>{e.exports=require("fs")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},98216:e=>{e.exports=require("net")},19801:e=>{e.exports=require("os")},55315:e=>{e.exports=require("path")},76162:e=>{e.exports=require("stream")},82452:e=>{e.exports=require("tls")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},97333:(e,t,o)=>{o.r(t),o.d(t,{originalPathname:()=>y,patchFetch:()=>w,requestAsyncStorage:()=>m,routeModule:()=>x,serverHooks:()=>b,staticGenerationAsyncStorage:()=>h});var r={};o.r(r),o.d(r,{OPTIONS:()=>f,POST:()=>u,dynamic:()=>g});var i=o(49303),n=o(88716),s=o(60670),a=o(87070),p=o(75748),l=o(98800),d=o(48744),c=o(61986);let g="force-dynamic";async function f(e){let t=e.headers.get("origin");return new Response(null,{status:204,headers:{"Access-Control-Allow-Origin":t&&c.T.includes(t)?t:"*","Access-Control-Allow-Methods":"POST, OPTIONS","Access-Control-Allow-Headers":"Content-Type, Authorization"}})}async function u(e){try{let t=e.headers.get("origin");if(t&&!c.T.includes(t))return a.NextResponse.json({success:!1,message:"CORS policy: Origin not allowed"},{status:403});let{email:o}=await e.json();if(!o||!o.includes("@"))return a.NextResponse.json({success:!1,message:"Valid email address is required"},{status:400});let r=o.toLowerCase().trim(),i=(await p.Z).db("connect_africa").collection("subscribers");if(await i.findOne({email:r}))return a.NextResponse.json({success:!0,message:"You're already subscribed to our newsletter"},{status:200});let n=Buffer.from(o+Date.now()).toString("base64");await i.insertOne({email:r,subscribedAt:new Date,status:"pending",verificationToken:n,unsubscribeToken:Buffer.from(o).toString("base64")});try{let e=(0,d.Q)(),{subject:t,html:o}=(0,l.pF)({verificationToken:n});await e.sendMail({from:'"Connect with Africa" <support@connectwithafrica.org>',to:r,subject:t,html:o})}catch(e){console.error("Error sending confirmation email:",e)}return a.NextResponse.json({success:!0,message:"Thank you for subscribing! Check your email to confirm your subscription."},{status:201})}catch(e){return console.error("Newsletter subscription error:",e),a.NextResponse.json({success:!1,message:"Subscription failed",error:e?.message},{status:500})}}let x=new i.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/v1/user/newsletter/subscribe/route",pathname:"/api/v1/user/newsletter/subscribe",filename:"route",bundlePath:"app/api/v1/user/newsletter/subscribe/route"},resolvedPagePath:"C:\\Users\\HP\\OneDrive\\Desktop\\project2\\connect africa\\src\\app\\api\\v1\\user\\newsletter\\subscribe\\route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:m,staticGenerationAsyncStorage:h,serverHooks:b}=x,y="/api/v1/user/newsletter/subscribe/route";function w(){return(0,s.patchFetch)({serverHooks:b,staticGenerationAsyncStorage:h})}},61986:(e,t,o)=>{o.d(t,{T:()=>r});let r=["http://localhost:3000","https://connectafrica-fawn.vercel.app","https://www.connectwithafrica.org","https://connectwithafrica.org"]},75748:(e,t,o)=>{o.d(t,{Z:()=>n});var r=o(38013);let i=process.env.MONGODB_URI;if(!i)throw Error("Please define MONGODB_URI in .env");let n=new r.MongoClient(i).connect()},98800:(e,t,o)=>{function r({name:e,reference:t,amountPaid:o,donationType:r,designation:i}){return{subject:`Thank you for your donation — ${t}`,html:`
  ...
  `}}function s({campaignTitle:e,campaignDescription:t,campaignImage:o,campaignLink:r,unsubscribeToken:i}){let n=`New Campaign: ${e} — Connect with Africa`,s=`http://localhost:3000/newsletter/unsubscribe?token=${encodeURIComponent(i)}`;return{subject:n,html:`
  <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial; color:#111; line-height:1.5;">
    <!-- Header with Logo -->
    <div style="max-width:680px;margin:0 auto;background:linear-gradient(135deg, #059669 0%, #047857 100%);padding:32px 24px;border-radius:8px 8px 0 0;text-align:center;">
      <img src="https://connectwithafrica.org/logo2.jpg" alt="Connect with Africa" style="height:50px;margin-bottom:16px;" />
