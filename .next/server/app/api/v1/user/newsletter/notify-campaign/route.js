"use strict";(()=>{var e={};e.id=9715,e.ids=[9715],e.modules={38013:e=>{e.exports=require("mongodb")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},61282:e=>{e.exports=require("child_process")},84770:e=>{e.exports=require("crypto")},80665:e=>{e.exports=require("dns")},17702:e=>{e.exports=require("events")},92048:e=>{e.exports=require("fs")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},98216:e=>{e.exports=require("net")},19801:e=>{e.exports=require("os")},55315:e=>{e.exports=require("path")},76162:e=>{e.exports=require("stream")},82452:e=>{e.exports=require("tls")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},37055:(e,t,o)=>{o.r(t),o.d(t,{originalPathname:()=>h,patchFetch:()=>b,requestAsyncStorage:()=>u,routeModule:()=>f,serverHooks:()=>x,staticGenerationAsyncStorage:()=>m});var r={};o.r(r),o.d(r,{POST:()=>g});var i=o(49303),n=o(88716),a=o(60670),s=o(87070),p=o(75748),l=o(55245),d=o(98800),c=o(61986);async function g(e){try{let t=e.headers.get("origin");if(t&&!c.T.includes(t))return s.NextResponse.json({success:!1,message:"CORS policy: Origin not allowed"},{status:403});let o=e.headers.get("authorization");if(!o||!o.startsWith("Bearer "))return s.NextResponse.json({success:!1,message:"Unauthorized"},{status:401});let{campaignTitle:r,campaignDescription:i,campaignImage:n,campaignId:a}=await e.json();if(!r||!i||!a)return s.NextResponse.json({success:!1,message:"Campaign title, description, and ID are required"},{status:400});let g=(await p.Z).db("connect_africa").collection("subscribers"),f=await g.find({status:"active"}).toArray();if(0===f.length)return s.NextResponse.json({success:!0,message:"No active subscribers to notify",emailsSent:0},{status:200});let u=l.createTransport({service:"gmail",auth:{user:process.env.GMAIL_USER,pass:process.env.GMAIL_PASS}}),m=`http://localhost:3000/campaigns/${a}`,x=0,h=0;for(let e of f)try{let{subject:t,html:o}=(0,d.RY)({campaignTitle:r,campaignDescription:i,campaignImage:n,campaignLink:m,unsubscribeToken:e.unsubscribeToken});await u.sendMail({from:process.env.GMAIL_USER,to:e.email,subject:t,html:o}),x++}catch(t){console.error(`Failed to send email to ${e.email}:`,t),h++}return s.NextResponse.json({success:!0,message:`Campaign notification sent to ${x} subscribers`,emailsSent:x,emailsFailed:h},{status:200})}catch(e){return console.error("Campaign notification error:",e),s.NextResponse.json({success:!1,message:"Failed to send campaign notification",error:e?.message},{status:500})}}let f=new i.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/v1/user/newsletter/notify-campaign/route",pathname:"/api/v1/user/newsletter/notify-campaign",filename:"route",bundlePath:"app/api/v1/user/newsletter/notify-campaign/route"},resolvedPagePath:"C:\\Users\\HP\\OneDrive\\Desktop\\project2\\connect africa\\src\\app\\api\\v1\\user\\newsletter\\notify-campaign\\route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:u,staticGenerationAsyncStorage:m,serverHooks:x}=f,h="/api/v1/user/newsletter/notify-campaign/route";function b(){return(0,a.patchFetch)({serverHooks:x,staticGenerationAsyncStorage:m})}},61986:(e,t,o)=>{o.d(t,{T:()=>r});let r=["http://localhost:3000","https://connectafrica-fawn.vercel.app","connectwithafrica.org"]},75748:(e,t,o)=>{o.d(t,{Z:()=>n});var r=o(38013);let i=process.env.MONGODB_URI;if(!i)throw Error("Please define MONGODB_URI in .env");let n=new r.MongoClient(i).connect()},98800:(e,t,o)=>{function r({name:e,reference:t,amountPaid:o,donationType:r,designation:i}){return{subject:`Thank you for your donation — ${t}`,html:`
  ...
  `}}o.d(t,{RY:()=>a,X:()=>i,aT:()=>r,pF:()=>n})}};var t=require("../../../../../../webpack-runtime.js");t.C(e);var o=e=>t(t.s=e),r=t.X(0,[9276,5972,5245],()=>o(37055));module.exports=r})();