"use strict";(()=>{var e={};e.id=5947,e.ids=[5947],e.modules={38013:e=>{e.exports=require("mongodb")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},61282:e=>{e.exports=require("child_process")},84770:e=>{e.exports=require("crypto")},80665:e=>{e.exports=require("dns")},17702:e=>{e.exports=require("events")},92048:e=>{e.exports=require("fs")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},98216:e=>{e.exports=require("net")},19801:e=>{e.exports=require("os")},55315:e=>{e.exports=require("path")},76162:e=>{e.exports=require("stream")},82452:e=>{e.exports=require("tls")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},45278:(e,t,o)=>{o.r(t),o.d(t,{originalPathname:()=>m,patchFetch:()=>h,requestAsyncStorage:()=>g,routeModule:()=>f,serverHooks:()=>x,staticGenerationAsyncStorage:()=>u});var r={};o.r(r),o.d(r,{GET:()=>c});var i=o(49303),n=o(88716),a=o(60670),s=o(87070),p=o(75748),l=o(55245),d=o(98800);async function c(e){try{let t=e.nextUrl.searchParams.get("token");if(!t)return s.NextResponse.json({success:!1,message:"Invalid verification link"},{status:400});let o=(await p.Z).db("connect_africa").collection("subscribers"),r=await o.findOne({verificationToken:t});if(!r)return s.NextResponse.json({success:!1,message:"Verification link expired or invalid"},{status:404});if("active"===r.status)return s.NextResponse.json({success:!1,message:"Email already verified"},{status:400});await o.updateOne({_id:r._id},{$set:{status:"active",verifiedAt:new Date,verificationToken:null}});try{let e=l.createTransport({service:"gmail",auth:{user:process.env.GMAIL_USER,pass:process.env.GMAIL_PASS}}),{subject:t,html:o}=(0,d.X)({unsubscribeToken:r.unsubscribeToken});await e.sendMail({from:process.env.GMAIL_USER,to:r.email,subject:t,html:o})}catch(e){console.error("Error sending welcome email:",e)}return s.NextResponse.json({success:!0,message:"Email verified successfully! Welcome to Connect Africa Newsletter."})}catch(e){return console.error("Newsletter verification error:",e),s.NextResponse.json({success:!1,message:"Verification failed",error:e?.message},{status:500})}}let f=new i.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/v1/user/newsletter/verify/route",pathname:"/api/v1/user/newsletter/verify",filename:"route",bundlePath:"app/api/v1/user/newsletter/verify/route"},resolvedPagePath:"C:\\Users\\HP\\OneDrive\\Desktop\\project2\\connect africa\\src\\app\\api\\v1\\user\\newsletter\\verify\\route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:g,staticGenerationAsyncStorage:u,serverHooks:x}=f,m="/api/v1/user/newsletter/verify/route";function h(){return(0,a.patchFetch)({serverHooks:x,staticGenerationAsyncStorage:u})}},75748:(e,t,o)=>{o.d(t,{Z:()=>n});var r=o(38013);let i=process.env.MONGODB_URI;if(!i)throw Error("Please define MONGODB_URI in .env");let n=new r.MongoClient(i).connect()},98800:(e,t,o)=>{function r({name:e,reference:t,amountPaid:o,donationType:r,designation:i}){return{subject:`Thank you for your donation — ${t}`,html:`
  ...
  `}}o.d(t,{RY:()=>a,X:()=>i,aT:()=>r,pF:()=>n})}};var t=require("../../../../../../webpack-runtime.js");t.C(e);var o=e=>t(t.s=e),r=t.X(0,[9276,5972,5245],()=>o(45278));module.exports=r})();