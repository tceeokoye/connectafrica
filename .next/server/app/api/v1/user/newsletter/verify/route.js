"use strict";(()=>{var e={};e.id=5947,e.ids=[5947],e.modules={38013:e=>{e.exports=require("mongodb")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},61282:e=>{e.exports=require("child_process")},84770:e=>{e.exports=require("crypto")},80665:e=>{e.exports=require("dns")},17702:e=>{e.exports=require("events")},92048:e=>{e.exports=require("fs")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},98216:e=>{e.exports=require("net")},19801:e=>{e.exports=require("os")},55315:e=>{e.exports=require("path")},76162:e=>{e.exports=require("stream")},82452:e=>{e.exports=require("tls")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},45278:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>m,patchFetch:()=>h,requestAsyncStorage:()=>g,routeModule:()=>f,serverHooks:()=>x,staticGenerationAsyncStorage:()=>u});var o={};r.r(o),r.d(o,{GET:()=>c});var i=r(49303),n=r(88716),a=r(60670),s=r(87070),p=r(75748),l=r(55245),d=r(98800);async function c(e){try{let t=e.nextUrl.searchParams.get("token");if(!t)return s.NextResponse.json({success:!1,message:"Invalid verification link"},{status:400});let r=(await p.Z).db("connect_africa").collection("subscribers"),o=await r.findOne({verificationToken:t});if(!o)return s.NextResponse.json({success:!1,message:"Verification link expired or invalid"},{status:404});if("active"===o.status)return s.NextResponse.json({success:!1,message:"Email already verified"},{status:400});await r.updateOne({_id:o._id},{$set:{status:"active",verifiedAt:new Date,verificationToken:null}});try{let e=l.createTransport({service:"gmail",auth:{user:process.env.GMAIL_USER,pass:process.env.GMAIL_PASS}}),{subject:t,html:r}=(0,d.X)({unsubscribeToken:o.unsubscribeToken});await e.sendMail({from:process.env.GMAIL_USER,to:o.email,subject:t,html:r})}catch(e){console.error("Error sending welcome email:",e)}return s.NextResponse.json({success:!0,message:"Email verified successfully! Welcome to Connect Africa Newsletter."})}catch(e){return console.error("Newsletter verification error:",e),s.NextResponse.json({success:!1,message:"Verification failed",error:e?.message},{status:500})}}let f=new i.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/v1/user/newsletter/verify/route",pathname:"/api/v1/user/newsletter/verify",filename:"route",bundlePath:"app/api/v1/user/newsletter/verify/route"},resolvedPagePath:"C:\\Users\\HP\\OneDrive\\Desktop\\project2\\connect africa\\src\\app\\api\\v1\\user\\newsletter\\verify\\route.ts",nextConfigOutput:"",userland:o}),{requestAsyncStorage:g,staticGenerationAsyncStorage:u,serverHooks:x}=f,m="/api/v1/user/newsletter/verify/route";function h(){return(0,a.patchFetch)({serverHooks:x,staticGenerationAsyncStorage:u})}},75748:(e,t,r)=>{r.d(t,{Z:()=>n});var o=r(38013);let i=process.env.MONGODB_URI;if(!i)throw Error("Please define MONGODB_URI in .env");let n=new o.MongoClient(i).connect()},98800:(e,t,r)=>{function o({name:e,reference:t,amountPaid:r,donationType:o,designation:i}){return{subject:`Thank you for your donation — ${t}`,html:`
  ...
  `}}function a({campaignTitle:e,campaignDescription:t,campaignImage:r,campaignLink:o,unsubscribeToken:i}){let n=`New Campaign: ${e} — Connect Africa`,a=`http://localhost:3000/newsletter/unsubscribe?token=${encodeURIComponent(i)}`;return{subject:n,html:`
  <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial; color:#111; line-height:1.5;">
    <!-- Header with Logo -->
    <div style="max-width:680px;margin:0 auto;background:linear-gradient(135deg, #059669 0%, #047857 100%);padding:32px 24px;border-radius:8px 8px 0 0;text-align:center;">
      <img src="https://connectwithafrica.org/logo2.jpg" alt="Connect Africa" style="height:50px;margin-bottom:16px;" />
  ...
  `}}r.d(t,{RY:()=>a,X:()=>i,aT:()=>o,pF:()=>n})}};var t=require("../../../../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),o=t.X(0,[9276,5972,5245],()=>r(45278));module.exports=o})();