"use strict";(()=>{var e={};e.id=6641,e.ids=[6641],e.modules={38013:e=>{e.exports=require("mongodb")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},61282:e=>{e.exports=require("child_process")},84770:e=>{e.exports=require("crypto")},80665:e=>{e.exports=require("dns")},17702:e=>{e.exports=require("events")},92048:e=>{e.exports=require("fs")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},98216:e=>{e.exports=require("net")},19801:e=>{e.exports=require("os")},55315:e=>{e.exports=require("path")},76162:e=>{e.exports=require("stream")},82452:e=>{e.exports=require("tls")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},19379:(e,t,o)=>{o.r(t),o.d(t,{originalPathname:()=>h,patchFetch:()=>y,requestAsyncStorage:()=>u,routeModule:()=>f,serverHooks:()=>x,staticGenerationAsyncStorage:()=>m});var r={};o.r(r),o.d(r,{POST:()=>g});var i=o(49303),n=o(88716),a=o(60670),s=o(87070),p=o(75748),d=o(98800),l=o(55245);async function c(e,t){try{let o=e.headers.get("paypal-transmission-id"),r=e.headers.get("paypal-transmission-time"),i=e.headers.get("paypal-cert-url"),n=e.headers.get("paypal-transmission-sig"),a=process.env.PAYPAL_WEBHOOK_ID;if(!o||!r||!i||!n||!a)return console.error("Missing PayPal webhook headers"),!1;let s=Buffer.from(`${process.env.PAYPAL_CLIENT_ID}:${process.env.PAYPAL_SECRET}`).toString("base64"),p=await fetch(`${process.env.PAYPAL_API_URL}/v1/oauth2/token`,{method:"POST",headers:{Authorization:`Basic ${s}`,"Content-Type":"application/x-www-form-urlencoded"},body:"grant_type=client_credentials"}),d=(await p.json()).access_token,l=await fetch(`${process.env.PAYPAL_API_URL}/v1/notifications/verify-webhook-signature`,{method:"POST",headers:{Authorization:`Bearer ${d}`,"Content-Type":"application/json"},body:JSON.stringify({transmission_id:o,transmission_time:r,cert_url:i,auth_algo:"SHA256withRSA",transmission_sig:n,webhook_id:a,webhook_event:JSON.parse(t)})}),c=await l.json();return"SUCCESS"===c.verification_status}catch(e){return console.error("PayPal webhook verification error:",e),!1}}async function g(e){let t="";try{if(t=await e.text(),!await c(e,t))return console.error("Invalid PayPal webhook signature"),s.NextResponse.json({success:!1,message:"Invalid signature"},{status:401});let r=JSON.parse(t);if("CHECKOUT.ORDER.COMPLETED"!==r.event_type)return console.log("Ignoring event type:",r.event_type),s.NextResponse.json({message:"Event type ignored"});let i=r.resource;if(!i||!i.id)return s.NextResponse.json({success:!1,message:"Missing order data"},{status:400});let n=(await p.Z).db("connect_africa"),a=n.collection("donations"),g=await a.findOne({paypalOrderId:i.id,status:{$ne:"completed"}});if(!g)return console.log("Donation not found or already processed:",i.id),s.NextResponse.json({message:"Donation not found or already processed"});let f=i.purchase_units?.[0]?.amount?.value||g.amount,u=await a.updateOne({paypalOrderId:i.id},{$set:{status:"completed",completedAt:new Date,amountPaid:Number(f),paypalStatus:i.status}});if(0===u.modifiedCount)return console.error("Failed to update donation:",i.id),s.NextResponse.json({success:!1,message:"Failed to update donation"},{status:500});if(g.campaignId)try{let e=n.collection("campaigns"),{ObjectId:t}=o(38013);await e.updateOne({_id:new t(g.campaignId)},{$inc:{donatedAmount:Number(f),volunteers:1}})}catch(e){console.error("Error updating campaign:",e)}try{let e=l.createTransport({service:"gmail",auth:{user:process.env.GMAIL_USER,pass:process.env.GMAIL_PASS}}),{subject:t,html:o}=(0,d.aT)({name:g.firstName?`${g.firstName} ${g.lastName}`:g.name||"Friend",reference:i.id,amountPaid:Number(f),donationType:g.donationType||"one-time",designation:g.designation||"where-most-needed"});await e.sendMail({from:process.env.GMAIL_USER,to:g.email,subject:t,html:o}),console.log("Donation receipt email sent to:",g.email)}catch(e){console.error("Error sending donation receipt email:",e)}return s.NextResponse.json({success:!0,message:"Donation processed successfully",reference:i.id})}catch(e){return console.error("Donation webhook error:",e),s.NextResponse.json({success:!1,message:"Webhook processing failed",error:e?.message},{status:500})}}let f=new i.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/v1/user/donations/webhook/route",pathname:"/api/v1/user/donations/webhook",filename:"route",bundlePath:"app/api/v1/user/donations/webhook/route"},resolvedPagePath:"C:\\Users\\HP\\OneDrive\\Desktop\\project2\\connect africa\\src\\app\\api\\v1\\user\\donations\\webhook\\route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:u,staticGenerationAsyncStorage:m,serverHooks:x}=f,h="/api/v1/user/donations/webhook/route";function y(){return(0,a.patchFetch)({serverHooks:x,staticGenerationAsyncStorage:m})}},75748:(e,t,o)=>{o.d(t,{Z:()=>n});var r=o(38013);let i=process.env.MONGODB_URI;if(!i)throw Error("Please define MONGODB_URI in .env");let n=new r.MongoClient(i).connect()},98800:(e,t,o)=>{function r({name:e,reference:t,amountPaid:o,donationType:r,designation:i}){return{subject:`Thank you for your donation — ${t}`,html:`
  ...
  `}}function i({unsubscribeToken:e}){let t=`http://localhost:3000/newsletter/unsubscribe?token=${encodeURIComponent(e)}`;return{subject:"Welcome — Connect Africa Newsletter",html:`
  <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial; color:#111; line-height:1.5;">
    <!-- Header with Logo -->
    <div style="max-width:680px;margin:0 auto;background:linear-gradient(135deg, #059669 0%, #047857 100%);padding:32px 24px;border-radius:8px 8px 0 0;text-align:center;">
      <img src="https://connectwithafrica.org/logo2.jpg" alt="Connect Africa" style="height:50px;margin-bottom:16px;" />
  ...
  `}}function n({verificationToken:e}){let t=`http://localhost:3000/newsletter/verify?token=${encodeURIComponent(e)}`;return{subject:"Confirm Your Email — Connect Africa Newsletter",html:`
  <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial; color:#111; line-height:1.5;">
    <!-- Header with Logo -->
    <div style="max-width:680px;margin:0 auto;background:linear-gradient(135deg, #059669 0%, #047857 100%);padding:32px 24px;border-radius:8px 8px 0 0;text-align:center;">
      <img src="https://connectwithafrica.org/logo2.jpg" alt="Connect Africa" style="height:50px;margin-bottom:16px;" />
  ...
  `}}function a({campaignTitle:e,campaignDescription:t,campaignImage:o,campaignLink:r,unsubscribeToken:i}){let n=`New Campaign: ${e} — Connect Africa`,a=`http://localhost:3000/newsletter/unsubscribe?token=${encodeURIComponent(i)}`;return{subject:n,html:`
  <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial; color:#111; line-height:1.5;">
    <!-- Header with Logo -->
    <div style="max-width:680px;margin:0 auto;background:linear-gradient(135deg, #059669 0%, #047857 100%);padding:32px 24px;border-radius:8px 8px 0 0;text-align:center;">
      <img src="https://connectwithafrica.org/logo2.jpg" alt="Connect Africa" style="height:50px;margin-bottom:16px;" />
  ...
  `}}o.d(t,{RY:()=>a,X:()=>i,aT:()=>r,pF:()=>n})}};var t=require("../../../../../../webpack-runtime.js");t.C(e);var o=e=>t(t.s=e),r=t.X(0,[9276,5972,5245],()=>o(19379));module.exports=r})();