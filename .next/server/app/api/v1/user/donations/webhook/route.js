"use strict";(()=>{var e={};e.id=6641,e.ids=[6641],e.modules={38013:e=>{e.exports=require("mongodb")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},61282:e=>{e.exports=require("child_process")},84770:e=>{e.exports=require("crypto")},80665:e=>{e.exports=require("dns")},17702:e=>{e.exports=require("events")},92048:e=>{e.exports=require("fs")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},98216:e=>{e.exports=require("net")},19801:e=>{e.exports=require("os")},55315:e=>{e.exports=require("path")},76162:e=>{e.exports=require("stream")},82452:e=>{e.exports=require("tls")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},19379:(e,t,o)=>{o.r(t),o.d(t,{originalPathname:()=>b,patchFetch:()=>v,requestAsyncStorage:()=>x,routeModule:()=>m,serverHooks:()=>y,staticGenerationAsyncStorage:()=>h});var r={};o.r(r),o.d(r,{OPTIONS:()=>c,POST:()=>f,dynamic:()=>g});var n=o(49303),i=o(88716),a=o(60670),s=o(87070),p=o(75748),d=o(98800),l=o(55245);async function c(e){return new Response(null,{status:204,headers:{"Access-Control-Allow-Origin":e.headers.get("origin")||"*","Access-Control-Allow-Methods":"POST, OPTIONS","Access-Control-Allow-Headers":"Content-Type, Authorization"}})}let g="force-dynamic";async function u(e,t){try{let o=e.headers.get("paypal-transmission-id"),r=e.headers.get("paypal-transmission-time"),n=e.headers.get("paypal-cert-url"),i=e.headers.get("paypal-transmission-sig"),a=process.env.PAYPAL_WEBHOOK_ID;if(!o||!r||!n||!i||!a)return console.error("Missing PayPal webhook headers"),!1;let s=Buffer.from(`${process.env.PAYPAL_CLIENT_ID}:${process.env.PAYPAL_SECRET}`).toString("base64"),p=await fetch(`${process.env.PAYPAL_API_URL}/v1/oauth2/token`,{method:"POST",headers:{Authorization:`Basic ${s}`,"Content-Type":"application/x-www-form-urlencoded"},body:"grant_type=client_credentials"}),d=(await p.json()).access_token,l=await fetch(`${process.env.PAYPAL_API_URL}/v1/notifications/verify-webhook-signature`,{method:"POST",headers:{Authorization:`Bearer ${d}`,"Content-Type":"application/json"},body:JSON.stringify({transmission_id:o,transmission_time:r,cert_url:n,auth_algo:"SHA256withRSA",transmission_sig:i,webhook_id:a,webhook_event:JSON.parse(t)})}),c=await l.json();return"SUCCESS"===c.verification_status}catch(e){return console.error("PayPal webhook verification error:",e),!1}}async function f(e){let t="";try{if(t=await e.text(),!await u(e,t))return console.error("Invalid PayPal webhook signature"),s.NextResponse.json({success:!1,message:"Invalid signature"},{status:401});let r=JSON.parse(t);if("CHECKOUT.ORDER.COMPLETED"!==r.event_type)return console.log("Ignoring event type:",r.event_type),s.NextResponse.json({message:"Event type ignored"});let n=r.resource;if(!n||!n.id)return s.NextResponse.json({success:!1,message:"Missing order data"},{status:400});let i=(await p.Z).db("connect_africa"),a=i.collection("donations"),c=await a.findOne({paypalOrderId:n.id,status:{$ne:"completed"}});if(!c)return console.log("Donation not found or already processed:",n.id),s.NextResponse.json({message:"Donation not found or already processed"});let g=n.purchase_units?.[0]?.amount?.value||c.amount,f=await a.updateOne({paypalOrderId:n.id},{$set:{status:"completed",completedAt:new Date,amountPaid:Number(g),paypalStatus:n.status}});if(0===f.modifiedCount)return console.error("Failed to update donation:",n.id),s.NextResponse.json({success:!1,message:"Failed to update donation"},{status:500});if(c.campaignId)try{let e=i.collection("campaigns"),{ObjectId:t}=o(38013);await e.updateOne({_id:new t(c.campaignId)},{$inc:{donatedAmount:Number(g),volunteers:1}})}catch(e){console.error("Error updating campaign:",e)}try{let e=l.createTransport({service:"gmail",auth:{user:process.env.GMAIL_USER,pass:process.env.GMAIL_PASS}}),{subject:t,html:o}=(0,d.aT)({name:c.firstName?`${c.firstName} ${c.lastName}`:c.name||"Friend",reference:n.id,amountPaid:Number(g),donationType:c.donationType||"one-time",designation:c.designation||"where-most-needed"});await e.sendMail({from:process.env.GMAIL_USER,to:c.email,subject:t,html:o}),console.log("Donation receipt email sent to:",c.email)}catch(e){console.error("Error sending donation receipt email:",e)}return s.NextResponse.json({success:!0,message:"Donation processed successfully",reference:n.id})}catch(e){return console.error("Donation webhook error:",e),s.NextResponse.json({success:!1,message:"Webhook processing failed",error:e?.message},{status:500})}}let m=new n.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/api/v1/user/donations/webhook/route",pathname:"/api/v1/user/donations/webhook",filename:"route",bundlePath:"app/api/v1/user/donations/webhook/route"},resolvedPagePath:"C:\\Users\\HP\\OneDrive\\Desktop\\project2\\connect africa\\src\\app\\api\\v1\\user\\donations\\webhook\\route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:x,staticGenerationAsyncStorage:h,serverHooks:y}=m,b="/api/v1/user/donations/webhook/route";function v(){return(0,a.patchFetch)({serverHooks:y,staticGenerationAsyncStorage:h})}},75748:(e,t,o)=>{o.d(t,{Z:()=>i});var r=o(38013);let n=process.env.MONGODB_URI;if(!n)throw Error("Please define MONGODB_URI in .env");let i=new r.MongoClient(n).connect()},98800:(e,t,o)=>{function r({name:e,reference:t,amountPaid:o,donationType:r,designation:n}){return{subject:`Thank you for your donation — ${t}`,html:`
  ...
  `}}function n({unsubscribeToken:e}){let t=`http://localhost:3000/newsletter/unsubscribe?token=${encodeURIComponent(e)}`;return{subject:"Welcome — Connect Africa Newsletter",html:`
  <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial; color:#111; line-height:1.5;">
    <!-- Header with Logo -->
    <div style="max-width:680px;margin:0 auto;background:linear-gradient(135deg, #059669 0%, #047857 100%);padding:32px 24px;border-radius:8px 8px 0 0;text-align:center;">
      <img src="https://connectwithafrica.org/logo2.jpg" alt="Connect Africa" style="height:50px;margin-bottom:16px;" />
  ...
  `}}function i({verificationToken:e}){let t=`http://localhost:3000/newsletter/verify?token=${encodeURIComponent(e)}`;return{subject:"Confirm Your Email — Connect Africa Newsletter",html:`
  <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial; color:#111; line-height:1.5;">
    <!-- Header with Logo -->
    <div style="max-width:680px;margin:0 auto;background:linear-gradient(135deg, #059669 0%, #047857 100%);padding:32px 24px;border-radius:8px 8px 0 0;text-align:center;">
      <img src="https://connectwithafrica.org/logo2.jpg" alt="Connect Africa" style="height:50px;margin-bottom:16px;" />
  ...
  `}}function a({campaignTitle:e,campaignDescription:t,campaignImage:o,campaignLink:r,unsubscribeToken:n}){let i=`New Campaign: ${e} — Connect Africa`,a=`http://localhost:3000/newsletter/unsubscribe?token=${encodeURIComponent(n)}`;return{subject:i,html:`
  <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial; color:#111; line-height:1.5;">
    <!-- Header with Logo -->
    <div style="max-width:680px;margin:0 auto;background:linear-gradient(135deg, #059669 0%, #047857 100%);padding:32px 24px;border-radius:8px 8px 0 0;text-align:center;">
      <img src="https://connectwithafrica.org/logo2.jpg" alt="Connect Africa" style="height:50px;margin-bottom:16px;" />
  ...
  `}}o.d(t,{RY:()=>a,X:()=>n,aT:()=>r,pF:()=>i})}};var t=require("../../../../../../webpack-runtime.js");t.C(e);var o=e=>t(t.s=e),r=t.X(0,[9276,5972,5245],()=>o(19379));module.exports=r})();