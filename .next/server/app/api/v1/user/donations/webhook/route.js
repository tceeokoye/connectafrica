"use strict";(()=>{var e={};e.id=6641,e.ids=[6641],e.modules={38013:e=>{e.exports=require("mongodb")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},61282:e=>{e.exports=require("child_process")},84770:e=>{e.exports=require("crypto")},80665:e=>{e.exports=require("dns")},17702:e=>{e.exports=require("events")},92048:e=>{e.exports=require("fs")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},98216:e=>{e.exports=require("net")},19801:e=>{e.exports=require("os")},55315:e=>{e.exports=require("path")},76162:e=>{e.exports=require("stream")},82452:e=>{e.exports=require("tls")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},19379:(e,t,o)=>{o.r(t),o.d(t,{originalPathname:()=>w,patchFetch:()=>v,requestAsyncStorage:()=>h,routeModule:()=>x,serverHooks:()=>b,staticGenerationAsyncStorage:()=>y});var r={};o.r(r),o.d(r,{OPTIONS:()=>g,POST:()=>m,dynamic:()=>f});var i=o(49303),n=o(88716),s=o(60670),a=o(87070),p=o(75748),d=o(98800),l=o(48744),c=o(59930);async function g(e){return new Response(null,{status:204,headers:{"Access-Control-Allow-Origin":e.headers.get("origin")||"*","Access-Control-Allow-Methods":"POST, OPTIONS","Access-Control-Allow-Headers":"Content-Type, Authorization, stripe-signature"}})}let f="force-dynamic",u=new c.ZP(process.env.STRIPE_SECRET_KEY,{apiVersion:"2026-03-25.dahlia"});async function m(e){let t;try{let r=await e.text(),i=e.headers.get("stripe-signature");if(!i)return console.error("Missing Stripe signature"),a.NextResponse.json({success:!1,message:"Missing signature"},{status:400});try{t=u.webhooks.constructEvent(r,i,process.env.STRIPE_WEBHOOK_SECRET_DONATION||process.env.STRIPE_WEBHOOK_SECRET)}catch(e){return console.error("Stripe webhook verification error:",e.message),a.NextResponse.json({success:!1,message:"Webhook signature verification failed"},{status:400})}if("checkout.session.completed"!==t.type)return console.log("Ignoring event type:",t.type),a.NextResponse.json({message:"Event type ignored"});let n=t.data.object;if(!n||!n.id)return a.NextResponse.json({success:!1,message:"Missing session data"},{status:400});let s=(await p.Z).db("connect_africa"),c=s.collection("donations"),g=await c.findOne({stripeSessionId:n.id,status:{$ne:"completed"}});if(!g)return console.log("Donation not found or already processed:",n.id),a.NextResponse.json({message:"Donation not found or already processed"});let f=n.amount_total?n.amount_total/100:g.amount,m=await c.updateOne({stripeSessionId:n.id},{$set:{status:"completed",completedAt:new Date,amountPaid:Number(f),stripeStatus:n.payment_status}});if(0===m.modifiedCount)return console.error("Failed to update donation:",n.id),a.NextResponse.json({success:!1,message:"Failed to update donation"},{status:500});if(g.campaignId)try{let e=s.collection("campaigns"),{ObjectId:t}=o(38013);await e.updateOne({_id:new t(g.campaignId)},{$inc:{donatedAmount:Number(f),volunteers:1}})}catch(e){console.error("Error updating campaign:",e)}try{let e=(0,l.Q)(),{subject:t,html:o}=(0,d.aT)({name:g.firstName?`${g.firstName} ${g.lastName}`:g.name||"Friend",reference:g.reference||n.id,amountPaid:Number(f),donationType:g.donationType||"one-time",designation:g.designation||"where-most-needed"});await e.sendMail({from:'"Connect Africa" <support@connectwithafrica.org>',to:g.email,subject:t,html:o}),console.log("Donation receipt email sent to:",g.email)}catch(e){console.error("Error sending donation receipt email:",e)}return a.NextResponse.json({success:!0,message:"Donation processed successfully",reference:n.id})}catch(e){return console.error("Donation webhook error:",e),a.NextResponse.json({success:!1,message:"Webhook processing failed",error:e?.message},{status:500})}}let x=new i.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/v1/user/donations/webhook/route",pathname:"/api/v1/user/donations/webhook",filename:"route",bundlePath:"app/api/v1/user/donations/webhook/route"},resolvedPagePath:"C:\\Users\\HP\\OneDrive\\Desktop\\project2\\connect africa\\src\\app\\api\\v1\\user\\donations\\webhook\\route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:h,staticGenerationAsyncStorage:y,serverHooks:b}=x,w="/api/v1/user/donations/webhook/route";function v(){return(0,s.patchFetch)({serverHooks:b,staticGenerationAsyncStorage:y})}},75748:(e,t,o)=>{o.d(t,{Z:()=>a});var r=o(38013),i=o(80665),n=o.n(i);try{n().setServers(["8.8.8.8","1.1.1.1"])}catch{}let s=process.env.MONGODB_URI;if(!s)throw Error("Please define MONGODB_URI in .env");let a=new r.MongoClient(s).connect()},98800:(e,t,o)=>{function r({name:e,reference:t,amountPaid:o,donationType:r,designation:i}){return{subject:`Thank you for your donation — ${t}`,html:`
  ...
  `}}function s({campaignTitle:e,campaignDescription:t,campaignImage:o,campaignLink:r,unsubscribeToken:i}){let n=`New Campaign: ${e} — Connect with Africa`,s=`https://www.connectwithafrica.org/newsletter/unsubscribe?token=${encodeURIComponent(i)}`;return{subject:n,html:`
  <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial; color:#111; line-height:1.5;">
    <!-- Header with Logo -->
    <div style="max-width:680px;margin:0 auto;background:linear-gradient(135deg, #059669 0%, #047857 100%);padding:32px 24px;border-radius:8px 8px 0 0;text-align:center;">
      <img src="https://connectwithafrica.org/logo2.jpg" alt="Connect with Africa" style="height:50px;margin-bottom:16px;" />
