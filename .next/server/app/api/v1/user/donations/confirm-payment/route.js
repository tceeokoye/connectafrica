"use strict";(()=>{var e={};e.id=418,e.ids=[418],e.modules={38013:e=>{e.exports=require("mongodb")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},61282:e=>{e.exports=require("child_process")},84770:e=>{e.exports=require("crypto")},80665:e=>{e.exports=require("dns")},17702:e=>{e.exports=require("events")},92048:e=>{e.exports=require("fs")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},98216:e=>{e.exports=require("net")},19801:e=>{e.exports=require("os")},55315:e=>{e.exports=require("path")},76162:e=>{e.exports=require("stream")},82452:e=>{e.exports=require("tls")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},8484:(e,t,o)=>{o.r(t),o.d(t,{originalPathname:()=>v,patchFetch:()=>C,requestAsyncStorage:()=>y,routeModule:()=>h,serverHooks:()=>w,staticGenerationAsyncStorage:()=>b});var r={};o.r(r),o.d(r,{POST:()=>x,dynamic:()=>u});var i=o(49303),n=o(88716),a=o(60670),s=o(87070),p=o(75748),d=o(38013),l=o(98800),c=o(61986),f=o(48744),g=o(59930);let u="force-dynamic",m=new g.ZP(process.env.STRIPE_SECRET_KEY,{apiVersion:"2026-03-25.dahlia"});async function x(e){try{let t=e.headers.get("origin");if(t&&!c.T.includes(t))return s.NextResponse.json({success:!1,message:"CORS policy: Origin not allowed"},{status:403});let{reference:o}=await e.json();if(!o)return s.NextResponse.json({success:!1,message:"Reference is required"},{status:400});let r=(await p.Z).db("connect_africa"),i=r.collection("donations"),n=r.collection("campaigns"),a=await i.findOne({reference:o});if(!a)return s.NextResponse.json({success:!1,message:"Donation not found"},{status:404});if("completed"===a.status)return console.log("✅ Donation already completed:",o),s.NextResponse.json({success:!0,donation:a,alreadyProcessed:!0});if(!a.stripeSessionId)return s.NextResponse.json({success:!1,message:"No checkout session associated with this donation."},{status:400});let g=await m.checkout.sessions.retrieve(a.stripeSessionId);if("paid"!==g.payment_status)return s.NextResponse.json({success:!1,message:"Payment has not been completed yet."},{status:400});console.log("✅ Payment successful! Updating donation to completed...");let u=g.amount_total?g.amount_total/100:a.amount,x=await i.updateOne({reference:o},{$set:{status:"completed",completedAt:new Date,amountPaid:u,stripeStatus:g.payment_status}});console.log("✅ Donation marked as completed:",{reference:o,amount:u,modified:x.modifiedCount});let h=null;if(a.campaignId&&(h=await n.findOne({_id:new d.ObjectId(a.campaignId)}))){let e=(h.donatedAmount||0)+Number(u),t=e>=h.amount?"completed":"inprogress";console.log("\uD83D\uDCB5 Updating Campaign:",{title:h.title,previousAmount:h.donatedAmount||0,newAmount:e,newStatus:t});let o=await n.updateOne({_id:h._id},{$set:{donatedAmount:e,status:t,updatedAt:new Date},$inc:{volunteers:1}});console.log("✅ Campaign updated successfully, modified:",o.modifiedCount)}try{let e=(0,f.Q)();await e.verify();let{subject:t,html:o}=(0,l.aT)({name:a.firstName?`${a.firstName} ${a.lastName}`:a.name||"Friend",reference:a.reference,amountPaid:u,donationType:a.donationType||"one-time",designation:h?h.title:a.designation||"where-most-needed"});await e.sendMail({from:'"Connect Africa" <support@connectwithafrica.org>',to:a.email,subject:t,html:o}),console.log("✅ Email sent successfully to "+a.email)}catch(e){console.error("❌ Email sending failed:",e.message)}let y=await i.findOne({reference:o});return console.log("✅ PAYMENT CONFIRMATION COMPLETE"),console.log("\n"),s.NextResponse.json({success:!0,donation:y,paymentStatus:"SUCCESSFUL",message:"Payment confirmed and records updated"})}catch(e){return console.error("❌ Confirm payment error:",e),s.NextResponse.json({success:!1,message:"Error confirming payment: "+e.message},{status:500})}}let h=new i.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/v1/user/donations/confirm-payment/route",pathname:"/api/v1/user/donations/confirm-payment",filename:"route",bundlePath:"app/api/v1/user/donations/confirm-payment/route"},resolvedPagePath:"C:\\Users\\HP\\OneDrive\\Desktop\\project2\\connect africa\\src\\app\\api\\v1\\user\\donations\\confirm-payment\\route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:y,staticGenerationAsyncStorage:b,serverHooks:w}=h,v="/api/v1/user/donations/confirm-payment/route";function C(){return(0,a.patchFetch)({serverHooks:w,staticGenerationAsyncStorage:b})}},61986:(e,t,o)=>{o.d(t,{T:()=>r});let r=["http://localhost:3000","https://connectafrica-fawn.vercel.app","https://www.connectwithafrica.org","https://connectwithafrica.org"]},75748:(e,t,o)=>{o.d(t,{Z:()=>n});var r=o(38013);let i=process.env.MONGODB_URI;if(!i)throw Error("Please define MONGODB_URI in .env");let n=new r.MongoClient(i).connect()},98800:(e,t,o)=>{function r({name:e,reference:t,amountPaid:o,donationType:r,designation:i}){return{subject:`Thank you for your donation — ${t}`,html:`
