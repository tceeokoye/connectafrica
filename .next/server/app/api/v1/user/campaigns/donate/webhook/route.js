"use strict";(()=>{var e={};e.id=9111,e.ids=[9111],e.modules={38013:e=>{e.exports=require("mongodb")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},61282:e=>{e.exports=require("child_process")},84770:e=>{e.exports=require("crypto")},80665:e=>{e.exports=require("dns")},17702:e=>{e.exports=require("events")},92048:e=>{e.exports=require("fs")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},98216:e=>{e.exports=require("net")},19801:e=>{e.exports=require("os")},55315:e=>{e.exports=require("path")},76162:e=>{e.exports=require("stream")},82452:e=>{e.exports=require("tls")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},94885:(e,t,o)=>{o.r(t),o.d(t,{originalPathname:()=>w,patchFetch:()=>v,requestAsyncStorage:()=>h,routeModule:()=>x,serverHooks:()=>y,staticGenerationAsyncStorage:()=>b});var r={};o.r(r),o.d(r,{POST:()=>f,dynamic:()=>g});var n=o(49303),i=o(88716),s=o(60670),a=o(87070),p=o(75748),d=o(38013),l=o(98800),c=o(48744),u=o(59930);let g="force-dynamic",m=new u.ZP(process.env.STRIPE_SECRET_KEY,{apiVersion:"2026-03-25.dahlia"});async function f(e){let t;try{console.log("\n\uD83D\uDD14 STRIPE WEBHOOK RECEIVED");let o=await e.text(),r=e.headers.get("stripe-signature");if(!r)return console.error("Missing Stripe signature"),a.NextResponse.json({success:!1,message:"Missing signature"},{status:400});try{t=m.webhooks.constructEvent(o,r,process.env.STRIPE_WEBHOOK_SECRET_CAMPAIGN||process.env.STRIPE_WEBHOOK_SECRET)}catch(e){return console.error("❌ Signature verification failed - rejecting webhook:",e.message),a.NextResponse.json({success:!1,message:"Invalid signature"},{status:401})}if(console.log("\uD83D\uDCE8 Event Type:",t.type),"checkout.session.completed"!==t.type)return console.log("⏭️ Ignoring event type:",t.type),a.NextResponse.json({message:"Event type ignored"});let n=t.data.object;if(!n||!n.id)return console.error("❌ Missing session data"),a.NextResponse.json({success:!1,message:"Missing session data"},{status:400});console.log("\uD83D\uDCB3 Stripe Session ID:",n.id);let i=(await p.Z).db("connect_africa"),s=i.collection("donations"),u=i.collection("campaigns"),g=await s.findOne({stripeSessionId:n.id,status:{$ne:"completed"}});if(console.log("\uD83D\uDD0D Donation lookup result:",g?"✅ Found":"❌ Not found"),!g)return console.error("❌ Donation not found or already processed. Session ID:",n.id),a.NextResponse.json({success:!0,message:"Donation not found but webhook processed"});let f=n.amount_total?n.amount_total/100:g.amount;if(console.log("\uD83D\uDCCB Donation Details:",{stripeSessionId:g.stripeSessionId,status:g.status,amount:g.amount,campaignId:g.campaignId}),Math.abs(Number(f)-Number(g.amount))>.01)return console.error("❌ Amount mismatch:",{expected:g.amount,received:f}),a.NextResponse.json({success:!1,message:"Amount mismatch"},{status:400});if(!g.campaignId)return console.error("❌ Invalid campaign ID in donation"),a.NextResponse.json({success:!1,message:"Invalid campaign ID"},{status:400});let x=await u.findOne({_id:new d.ObjectId(g.campaignId)});if(console.log("\uD83C\uDFAF Campaign lookup:",x?`✅ Found: ${x.title}`:"❌ Not found"),!x)return a.NextResponse.json({success:!1,message:"Campaign not found"},{status:404});console.log("\uD83D\uDD04 Updating donation status to completed...");let h=await s.updateOne({stripeSessionId:n.id},{$set:{status:"completed",completedAt:new Date,amountPaid:Number(f),stripeStatus:n.payment_status}});if(console.log("✅ Donation updated:",{modifiedCount:h.modifiedCount,matchedCount:h.matchedCount}),0===h.modifiedCount)return console.error("❌ Failed to update campaign donation:",n.id),a.NextResponse.json({success:!1,message:"Failed to update donation"},{status:500});let b=(x.donatedAmount||0)+Number(f),y=b>=x.amount?"completed":"inprogress";console.log("\uD83D\uDCB5 Campaign Update:",{previousDonatedAmount:x.donatedAmount||0,newDonation:Number(f),totalNow:b,targetAmount:x.amount,newStatus:y});let w=await u.updateOne({_id:x._id},{$set:{donatedAmount:b,status:y,updatedAt:new Date},$inc:{volunteers:1}});console.log("✅ Campaign updated:",{modifiedCount:w.modifiedCount,donatedAmount:b});try{console.log("\uD83D\uDCE7 Sending confirmation email to:",g.email);let e=(0,c.Q)(),{subject:t,html:o}=(0,l.aT)({name:g.firstName?`${g.firstName} ${g.lastName}`:"Friend",reference:g.reference||n.id,amountPaid:Number(f),donationType:"one-time",designation:x.title});await e.sendMail({from:'"Connect Africa" <support@connectwithafrica.org>',to:g.email,subject:t,html:o}),console.log("✅ Confirmation email sent successfully to:",g.email)}catch(e){console.error("⚠️ Warning: Failed to send email:",e)}return console.log("\n✅ WEBHOOK PROCESSING COMPLETE"),console.log("   Session ID:",n.id),console.log("   Amount: $"+f),console.log("   Campaign:",x.title),console.log("   New Total: $"+b),console.log("\n"),a.NextResponse.json({success:!0,message:"Campaign donation processed successfully",reference:n.id})}catch(e){return console.error("\n❌ WEBHOOK ERROR:",e.message),console.error("Stack:",e.stack),a.NextResponse.json({success:!1,message:"Webhook processing failed"},{status:500})}}let x=new n.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/api/v1/user/campaigns/donate/webhook/route",pathname:"/api/v1/user/campaigns/donate/webhook",filename:"route",bundlePath:"app/api/v1/user/campaigns/donate/webhook/route"},resolvedPagePath:"C:\\Users\\HP\\OneDrive\\Desktop\\project2\\connect africa\\src\\app\\api\\v1\\user\\campaigns\\donate\\webhook\\route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:h,staticGenerationAsyncStorage:b,serverHooks:y}=x,w="/api/v1/user/campaigns/donate/webhook/route";function v(){return(0,s.patchFetch)({serverHooks:y,staticGenerationAsyncStorage:b})}},75748:(e,t,o)=>{o.d(t,{Z:()=>a});var r=o(38013),n=o(80665),i=o.n(n);try{i().setServers(["8.8.8.8","1.1.1.1"])}catch{}let s=process.env.MONGODB_URI;if(!s)throw Error("Please define MONGODB_URI in .env");let a=new r.MongoClient(s).connect()},98800:(e,t,o)=>{function r({name:e,reference:t,amountPaid:o,donationType:r,designation:n}){return{subject:`Thank you for your donation — ${t}`,html:`
  ...
  `}}function s({campaignTitle:e,campaignDescription:t,campaignImage:o,campaignLink:r,unsubscribeToken:n}){let i=`New Campaign: ${e} — Connect with Africa`,s=`https://www.connectwithafrica.org/newsletter/unsubscribe?token=${encodeURIComponent(n)}`;return{subject:i,html:`
  <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial; color:#111; line-height:1.5;">
    <!-- Header with Logo -->
    <div style="max-width:680px;margin:0 auto;background:linear-gradient(135deg, #059669 0%, #047857 100%);padding:32px 24px;border-radius:8px 8px 0 0;text-align:center;">
      <img src="https://connectwithafrica.org/logo2.jpg" alt="Connect with Africa" style="height:50px;margin-bottom:16px;" />
